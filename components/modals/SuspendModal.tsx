...
export default function SuspendOrganizationModal({
  organizationName,
  onClose,
  onConfirm,
  isLoading = false,
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white w-[420px] rounded-2xl shadow-2xl p-8 text-center">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full bg-yellow-600 text-white py-2 rounded-lg mb-3 hover:bg-yellow-700 transition disabled:opacity-60 disabled:cursor-not-allowed"
        >
          {isLoading ? "Suspending..." : "Suspend field"}
        </button>
